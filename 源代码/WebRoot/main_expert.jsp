...
<jsp:include page="check_expert_logstate.jsp"/>
...
<div data-options="region:'north',title:'header',split:true,noheader:true" style="height:60px;background-color:#01B1EA;">
	<div class="logo">农业专家系统后台管理</div>
	<div class="logout">您好，<%=session.getAttribute("expert")%> | <a href="logout">退出</a></div>
</div>   
...
<script type="text/javascript" src="js/admin_expert.js"></script>
