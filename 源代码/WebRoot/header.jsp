...
<nav class="navbar navbar-default navbar-fixed-top">
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <a href="<%=basePath %>index.jsp" class="navbar-brand">农业专家系统</a>
        </div>
        <!--小屏幕导航按钮和logo-->
        <!--导航-->
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-left">
                ...
                <!-- 
                 <li><a href="<%=basePath %>CropClass/frontlist">农作物分类</a></li>
                 <li><a href="<%=basePath %>UserInfo/frontlist">用户</a></li>
                 <li><a href="<%=basePath %>index.jsp">首页</a></li>
                 <li><a href="<%=basePath %>Reply/frontlist">帖子回复</a></li>
                  -->
                <li><a href="<%=basePath %>Crop/frontlist">农作物</a></li>
                <li><a href="<%=basePath %>Disease/frontlist">病害</a></li>
                <li><a href="<%=basePath %>Pest/frontlist">虫害</a></li>
                <li><a href="<%=basePath %>Zhenduan/frontlist">诊断</a></li>
                
                <li><a href="<%=basePath %>PostInfo/frontlist">论坛交流</a></li>
                <li><a href="<%=basePath %>Expert/frontlist">专家查询</a></li>
                <li><a href="<%=basePath %>Leaveword/frontlist">网站留言</a></li>
                <li><a href="<%=basePath %>Wxqk/frontlist">文献期刊</a></li>
             ...
             <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dLabel">
                        ...
                        <li><a href="<%=basePath %>PostInfo/postInfo_frontUserAdd.jsp"><span class="glyphicon glyphicon-user"></span>&nbsp;&nbsp;发布帖子</a></li>
                        <li><a href="<%=basePath %>PostInfo/userFrontlist"><span class="glyphicon glyphicon-cog"></span>&nbsp;&nbsp;我发布的帖子</a></li>
                        <li><a href="<%=basePath %>Leaveword/leaveword_frontUserAdd.jsp"><span class="glyphicon glyphicon-user"></span>&nbsp;&nbsp;发布留言</a></li>
                        <li><a href="<%=basePath %>Leaveword/userFrontlist"><span class="glyphicon glyphicon-cog"></span>&nbsp;&nbsp;我发布的留言</a></li>
